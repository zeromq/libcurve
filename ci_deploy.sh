...
if [ "$BUILD_TYPE" == "default" ]; then
    ...
    cp bindings/jni/android/curve-android.jar curve-android-1.0.0.jar
    export CURVE_DEPLOYMENT=curve-android-1.0.0.jar
else
    export CURVE_DEPLOYMENT=""
fi
